...
OrderMaker :: OrderMaker(int num_atts, int which_atts[], Type type_atts[]){

	numAtts = num_atts;
	for(int i =0 ; i < numAtts; i++){
		whichAtts[i] = which_atts[i];	
		whichTypes[i] = type_atts[i];
	}
}
